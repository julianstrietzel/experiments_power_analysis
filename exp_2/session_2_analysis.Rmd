...
```{r}
model_not_interacted = data[, lm(success_rate ~ treatment + factor(team) + factor(person))]
...
stargazer(model_not_interacted, model_interacted_person, model_interacted_team, type = "text")
```
